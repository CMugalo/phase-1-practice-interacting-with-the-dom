...
let playing = !0,
  ...
  commentSection = document.getElementsByTagName("form")[0];
minus.addEventListener("click", function () {
  ...
  heart.addEventListener("click", function () {
    ...
    if (
      ...
      let e = parseInt(d.children[0].textContent);
  ...
  pause.addEventListener("click", function () {
    playing
      ? ((playing = !1), clearInterval(interval), (this.textContent = "resume"))
      : ((playing = !0), (interval = timer()), (this.textContent = "pause")),
      []
        .concat(timerArray(document.getElementsByTagName("button")))
        .forEach(function (a) {
  ...
  commentSection.addEventListener("submit", function (a) {
    ...
    (e.textContent = c), d.appendChild(e);
  });
